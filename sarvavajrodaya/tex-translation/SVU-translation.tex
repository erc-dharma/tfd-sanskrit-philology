...
\item[Vajralāsyā, Vajramālā, Vajragītā, Vajranṛtyā, Vajradhūpā, Vajrapuṣpā, Vajradīpā, Vajragandhā]
producing liberality, good conduct, forbearance, heroism, wisdom, concentration, resolve and means\footnote{The limitation to eight \emph{pāramitā}s, and not 10, is due to the match with eight goddesses of worship. KSP (ed. Inui §159) too mentions only the same eight: \emph{sarvatathāgata-dāna-pāramitā-niṣpādane, evaṁ śīla-kṣānti-vīrya-dhyāna-prajñā-praṇidhy-upāya[-niṣpādane]}. We do not know why these eight specifically were selected.}
...
[empower] the tribute (\skt{bali}), pronouncing \mantra{the syllable a is the gate of all entities because of their primordial beginninglessness},\footnote{Allusion to Arapacana, and thus to the sword, is evident from the extensive version at Pañcaviṁśatiprajñāpāramitā 1. 
%PvsP1-2: 85
